            ...
            <div className="footer">
                ...
                <div className="footerMenu">
                    <div className="footerMenu__column">
                        <span className="footerMenu__title">
                            Get to Know Us
                        </span>
                    ...
                    <div className="footerMenu__column">
                        ...
                        <div className="footerMenu__items">
                            <span className="footerMenu__item">Amazon Rewards Visa Signature Cards</span>
                            <span className="footerMenu__item">Amazon.com Store Card</span>
                            <span className="footerMenu__item">Amazon Business Card</span>
                            <span className="footerMenu__item">Amazon Business Line of Credit</span>
                            ...
                            <span className="footerMenu__item">Amazon Currency Converter</span>
                        </div>
                    </div>
                    <div className="footerMenu__column">
                        <span className="footerMenu__title">
                        ...
                        <div className="footerMenu__items">
                            ...
                            <span className="footerMenu__item">Shipping Rates & Policies</span>
                            <span className="footerMenu__item">Amazon Prime</span>
                            <span className="footerMenu__item">Returns & Replacements</span>
                            <span className="footerMenu__item">Manage Your Content and Devices</span>
