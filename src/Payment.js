...
function Payment() {
    ...
    useEffect(() => {
        //generate stripe secret to allow us to charge customer
        const getClientSecret = async () => {
            const response = await axios({
                method: 'post',
                //converting from dollars to cents (stripe expects subunits)
    ...
    const handleChange = event => {
        //listen for changes in CardElement and display any errors as the customer types their details
